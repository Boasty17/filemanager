...
$auth_users = array(
    'LunatiikXD' => '$2y$10$3w7ZipW6QAzPTI7FivvlU.YcJ5eN1AbaWv/.WIsfyPku6IqN1hMri' //admin@123
);
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="text-center">
                            <h1 class="card-title">Lunatiiks FTP</h1>
                        </div>
                        <div class="card fat">
                            <div class="card-body">
                        ...
                        <div class="footer text-center">
                            ...
                            <a href="" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">Lunatiiks FTP</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="" target="_blank" class="app-v-title"> Lunatiiks FTP <?php echo VERSION; ?></a></h3></p>
                        <p>Owner: LunatiikXD</p>
                        <p>Powered by PHP</p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Lunatiiks FTP<?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Lunatiiks FTP<?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
...
function fm_show_nav_path($path)
{
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white mb-4 main-nav <?php echo $isStickyNavBar ?>">
        <a class="navbar-brand" href="">Lunatiiks FTP</a>
